// Constants
//------------------------------------------------------------------------------
const Int_t   njetet = 3;

const Float_t muojetarray[njetet] = {20, 30, 45}; 
const Float_t elejetarray[njetet] = {20, 30, 45}; 
const Float_t colors     [njetet] = {kRed, kRed+1, kRed+2};
...
Bool_t  performDataMC           = true; //this
  ...
  if (performDataMC && the_elejetet > 0 && the_muojetet > 0)
    {
      ...
      GetLepScale("Ele",  "loose", "lept1", "lep_{pT1}", "GeV", the_elejetet);
      GetLepScale("Ele",  "tight", "lept1", "lep_{pT1}", "GeV", the_elejetet);
      GetLepScale("Muon", "loose", "lept1", "lep_{pT1}", "GeV", the_muojetet);
      GetLepScale("Muon", "tight", "lept1", "lep_{pT1}", "GeV", the_muojetet);

      GetLepScale("Ele",  "loose", "lept1", "lep_{pT1}", "GeV", the_elejetet, "00_QCD");
      GetLepScale("Ele",  "tight", "lept1", "lep_{pT1}", "GeV", the_elejetet, "00_QCD");
      GetLepScale("Muon", "loose", "lept1", "lep_{pT1}", "GeV", the_muojetet, "00_QCD");
      GetLepScale("Muon", "tight", "lept1", "lep_{pT1}", "GeV", the_muojetet, "00_QCD");

      GetLepScale("Ele",  "loose", "lept2", "lep_{pT2}", "GeV", the_elejetet);
      GetLepScale("Ele",  "tight", "lept2", "lep_{pT2}", "GeV", the_elejetet);
      GetLepScale("Muon", "loose", "lept2", "lep_{pT2}", "GeV", the_muojetet);
      GetLepScale("Muon", "tight", "lept2", "lep_{pT2}", "GeV", the_muojetet);

      GetLepScale("Ele",  "loose", "lepeta1", "lep_{eta1}", "GeV", the_elejetet);
      GetLepScale("Ele",  "tight", "lepeta1", "lep_{eta1}", "GeV", the_elejetet);
      GetLepScale("Muon", "loose", "lepeta1", "lep_{eta1}", "GeV", the_muojetet);
      GetLepScale("Muon", "tight", "lepeta1", "lep_{eta1}", "GeV", the_muojetet);

      GetLepScale("Ele",  "loose", "lepeta1", "lep_{eta1}", "GeV", the_elejetet, "00_QCD");
      GetLepScale("Ele",  "tight", "lepeta1", "lep_{eta1}", "GeV", the_elejetet, "00_QCD");
      GetLepScale("Muon", "loose", "lepeta1", "lep_{eta1}", "GeV", the_muojetet, "00_QCD");
      GetLepScale("Muon", "tight", "lepeta1", "lep_{eta1}", "GeV", the_muojetet, "00_QCD");

      GetLepScale("Ele",  "loose", "lepeta2", "lep_{eta2}", "GeV", the_elejetet);
      GetLepScale("Ele",  "tight", "lepeta2", "lep_{eta2}", "GeV", the_elejetet);
      GetLepScale("Muon", "loose", "lepeta2", "lep_{eta2}", "GeV", the_muojetet);
      GetLepScale("Muon", "tight", "lepeta2", "lep_{eta2}", "GeV", the_muojetet);
    }
}
        ...
        TString FRdir = "01_Zpeak")
{
  ...
  TH1D* h_data  = (TH1D*)dataFR ->Get(btagdir + "FR/"+FRdir+"/h_" + flavour + "_" + loose_tight + "_" + suffix);
  printf("\n %s \n", variable.Data());
  ...
  // float max = 0.;
  // if(ytitle == "muons") { max = 180.;}
  // else { max = 80.;}

  // h_zjets->GetYaxis()->SetRangeUser(0.,max);
  // if(variable.EqualTo("m2l")) { h_zjets->GetXaxis()->SetRangeUser(80., 100.);}
  // h_zjets->GetXaxis()->SetRangeUser(80., 100.);
  ...
  // Save
  //----------------------------------------------------------------------------
  canvas->SaveAs(Form("%s/%s_%s_%s_%.0fGeV_%s.png",
		      pngdir.Data(),
		      flavour.Data(),
		      loose_tight.Data(),
		      variable.Data(),
